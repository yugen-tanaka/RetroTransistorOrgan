...
private let log = Logger(subsystem: "net.yuguen.organ.RetroTransistorOrganExtension", category: "AudioUnitViewController")

@MainActor
public class AudioUnitViewController: AUViewController, AUAudioUnitFactory {
    var audioUnit: AUAudioUnit?
    
    var hostingController: HostingController<RetroTransistorOrganExtensionMainView>?
	...
	*/
    ...
    private func configureSwiftUIView(audioUnit: AUAudioUnit) {
        ...
        let content = RetroTransistorOrganExtensionMainView(parameterTree: observableParameterTree)
